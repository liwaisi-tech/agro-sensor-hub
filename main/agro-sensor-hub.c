...
void app_main (void) {
    xTaskCreate(send_medicones_task, "send_medicones_task", 2048, NULL, 1, NULL);
    // Crear tarea para recibir mediciones
    xTaskCreate(receive_medicones_task, "receive_medicones_task", configMINIMAL_STACK_SIZE, NULL,2, NULL);
}
